#if !defined(_YDA160_SNDAMP_DIAG_H)
...
#define SNDAMP_IOCTL_SETPATH        _IOW(SOUNDAMP_IOCTL_MAGIC, 0x05, sndamp_diag_ctrl_type) 
#define SNDAMP_IOCTL_SPEAKER_LR_ON_OFF	_IOW(SOUNDAMP_IOCTL_MAGIC, 0x06, sndamp_diag_ctrl_type) 
